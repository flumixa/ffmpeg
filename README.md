...
|------------------------------------------------------------|--------------|------------------------------------------|---------------------------------------------|
| docker.io/sharapov/flumixa-base:alpine-ffmpeg-latest       | Alpine 3.20  | linux/amd64, linux/arm64, linux/arm/v7   | -                                           |
| docker.io/sharapov/flumixa-base:alpine-ffmpeg-rpi-latest   | Alpine 3.20  | Raspberry Pi (linux/arm/v7, linux/arm64) | MMAL/OMX/V4L2-M2M (32bit), V4L2-M2M (64bit) |
| docker.io/sharapov/flumixa-base:ubuntu-ffmpeg-cuda-latest  | Ubuntu 22.04 | linux/amd64                              | Nvidia Cuda                                 |
| docker.io/sharapov/flumixa-base:ubuntu-ffmpeg-vaapi-latest | Ubuntu 22.04 | linux/amd64                              | Intel VAAPI                                 |

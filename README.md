...
|------------------------------------------------------|--------------|------------------------------------------|---------------------------------------------|
| docker.io/sharapov/flumixa-base:ffmpeg-latest        | Alpine 3.21  | linux/amd64, linux/arm64, linux/arm/v7   | -                                           |
| docker.io/sharapov/flumixa-base:ffmpeg-rpi-latest    | Alpine 3.21  | Raspberry Pi (linux/arm/v7, linux/arm64) | MMAL/OMX/V4L2-M2M (32bit), V4L2-M2M (64bit) |
